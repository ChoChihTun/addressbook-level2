...
public class Messages {
    ...
    public static final String MESSAGE_INVALID_PERSON_PROPERTY = "The property provided is invalid";
    public static final String MESSAGE_INVALID_PROPERTY_PROVIDED = "%1$s provided is invalid";
