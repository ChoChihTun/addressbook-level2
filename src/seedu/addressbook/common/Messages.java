...
public class Messages {
    ...
    public static final String MESSAGE_INVALID_PERSON_DETAIL = "The detail does not exist in address book";
    public static final String MESSAGE_INVALID_DETAIL_PROVIDED = "%1$s provided is invalid";
